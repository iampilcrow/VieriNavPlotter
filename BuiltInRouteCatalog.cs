...
internal static class BuiltInRouteCatalog
{
    ...
    [
        ...
        ], true, true, "Uses the measured walkable standing point directly in front of the level-64 accessories vendor. The NPC object coordinate is retained separately for native interaction checks and is not a movement point. Flight remains available for the long post-teleport approach.", LastPointTolerance: 0.75f,
        ...
        ], true, true, "Uses the measured walkable standing point directly in front of the level-66 accessories vendor. The NPC object coordinate is retained separately for native interaction checks and is not a movement point. Flight remains available when a long approach requires it.", LastPointTolerance: 0.75f,
